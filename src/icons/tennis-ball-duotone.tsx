...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M32,128a96,96,0,0,1,95.83-96h0A96,96,0,0,1,32,127.83Z" opacity="0.2" />
      <SvgPath
...
export const TennisBallDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
