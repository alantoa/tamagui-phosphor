...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgRect x="32" y="72" width="112" height="112" rx="8" opacity="0.2" />
      <SvgRect
        x="32"
        y="72"
        width="112"
...
Icon.displayName = 'MicrosoftTeamsLogoDuotone'

export const MicrosoftTeamsLogoDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
