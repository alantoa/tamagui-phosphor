...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgRect x="48" y="56" width="160" height="144" rx="24" opacity="0.2" />
...
Icon.displayName = 'LegoSmileyDuotone'

export const LegoSmileyDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
