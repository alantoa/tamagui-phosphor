...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M128,104l32-16,32,16,22.83-11.42a56,56,0,0,0-109.66,0Z" opacity="0.2" />
      <SvgPath
...
Icon.displayName = 'PepperDuotone'

export const PepperDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
