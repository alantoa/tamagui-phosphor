  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath
        ...
        opacity="0.2"
      />
      <SvgPath d="M124.37,173.78,93.76,205.54A8,8,0,0,1,80,200V134.87Z" opacity="0.2" />
      <SvgPath
...
export const TelegramLogoDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
