  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath
        ...
        strokeWidth="12"
      />
      <_Circle cx="128" cy="76" r="10" />
      <_Circle cx="84" cy="100" r="10" />
      <_Circle cx="84" cy="156" r="10" />
      <_Circle cx="172" cy="100" r="10" />
    </Svg>
  )
}

Icon.displayName = 'PaletteLight'

export const PaletteLight: NamedExoticComponent<IconProps> = memo<IconProps>(themed(Icon))
