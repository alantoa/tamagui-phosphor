...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPolygon points="88 128 24 192 96 216 136 176 88 128" opacity="0.2" />
      <SvgPolyline
...
Icon.displayName = 'HighlighterDuotone'

export const HighlighterDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
