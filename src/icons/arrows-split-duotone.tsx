...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPolygon points="192 216 192 136 128 72 64 136 64 216 192 216" opacity="0.2" />
      <SvgPolyline
...
export const ArrowsSplitDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
