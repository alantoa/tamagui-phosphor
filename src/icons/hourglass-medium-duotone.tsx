...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPolygon points="74.67 88 180.92 88 128 128 74.67 88" opacity="0.2" />
      <SvgPath
...
Icon.displayName = 'HourglassMediumDuotone'

export const HourglassMediumDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
