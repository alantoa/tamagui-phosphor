...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <_Circle cx="164" cy="140" r="8" />
      <_Circle cx="116" cy="92" r="8" />
      <SvgPath
...
Icon.displayName = 'SmileyMeltingThin'

export const SmileyMeltingThin: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
