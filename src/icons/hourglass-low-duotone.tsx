...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M192,184H64v32a8,8,0,0,0,8,8H184a8,8,0,0,0,8-8Z" opacity="0.2" />
      <SvgPath
...
Icon.displayName = 'HourglassLowDuotone'

export const HourglassLowDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
