  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath
        ...
        strokeWidth="8"
      />
      <_Circle cx="68" cy="132" r="8" />
      <_Circle cx="188" cy="132" r="8" />
    </Svg>
  )
}

Icon.displayName = 'JeepThin'

export const JeepThin: NamedExoticComponent<IconProps> = memo<IconProps>(themed(Icon))
