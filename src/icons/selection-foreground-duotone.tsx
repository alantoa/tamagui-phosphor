...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgRect x="40" y="88" width="128" height="128" rx="8" opacity="0.2" />
      <SvgPath
...
Icon.displayName = 'SelectionForegroundDuotone'

export const SelectionForegroundDuotone: NamedExoticComponent<IconProps> =
