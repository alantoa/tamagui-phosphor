...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M48,128c0-64,80-72,80-104,0,32,80,40,80,104Z" opacity="0.2" />
      <SvgPath
...
Icon.displayName = 'MosqueDuotone'

export const MosqueDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
