  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <Line
        ...
        strokeWidth="12"
      />
      <_Circle cx="100" cy="124" r="10" />
      <_Circle cx="156" cy="124" r="10" />
      <SvgPath
...
Icon.displayName = 'CowLight'

export const CowLight: NamedExoticComponent<IconProps> = memo<IconProps>(themed(Icon))
