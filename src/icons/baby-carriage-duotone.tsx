...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M144,112V48a8,8,0,0,1,8-8h8a72,72,0,0,1,72,72H144Z" opacity="0.2" />
      <SvgPath
...
Icon.displayName = 'BabyCarriageDuotone'

export const BabyCarriageDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
