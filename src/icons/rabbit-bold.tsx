...
const Icon = (props) => {
  ...
  return (
    ...
    >
      ...
      <_Circle cx="104" cy="160" r="16" />
      <_Circle cx="152" cy="160" r="16" />
      <Polyline
...
Icon.displayName = 'RabbitBold'

export const RabbitBold: NamedExoticComponent<IconProps> = memo<IconProps>(themed(Icon))
