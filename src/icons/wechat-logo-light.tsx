...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <_Circle cx="132" cy="140" r="10" />
      <_Circle cx="188" cy="140" r="10" />
      <SvgPath
...
Icon.displayName = 'WechatLogoLight'

export const WechatLogoLight: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
