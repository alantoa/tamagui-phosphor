...
const Icon = (props) => {
	...
	return (
		<Svg viewBox="0 0 256 256" {...otherProps}>
			...
			<_Circle cx="132" cy="140" r="8" />
			<_Circle cx="188" cy="140" r="8" />
			<Path
...
Icon.displayName = "WechatLogoThin";

export const WechatLogoThin: NamedExoticComponent<IconProps> = memo<IconProps>(
	themed(Icon),
);
