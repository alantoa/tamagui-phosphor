...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M48,208H16a8,8,0,0,1-8-8V160a8,8,0,0,1,8-8H48Z" opacity="0.2" />
      <SvgPath
...
Icon.displayName = 'HandArrowUpDuotone'

export const HandArrowUpDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
