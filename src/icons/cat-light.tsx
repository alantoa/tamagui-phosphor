  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath
        ...
        strokeWidth="12"
      />
      <_Circle cx="84" cy="140" r="10" />
      <_Circle cx="172" cy="140" r="10" />
    </Svg>
  )
}

Icon.displayName = 'CatLight'

export const CatLight: NamedExoticComponent<IconProps> = memo<IconProps>(themed(Icon))
