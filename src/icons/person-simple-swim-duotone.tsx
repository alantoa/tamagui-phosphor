  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath
        ...
        opacity="0.2"
      />
      <_Circle cx="176" cy="72" r="24" opacity="0.2" />
      <_Circle
        cx="176"
        cy="72"
        r="24"
...
Icon.displayName = 'PersonSimpleSwimDuotone'

export const PersonSimpleSwimDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
