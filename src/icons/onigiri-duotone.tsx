...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M88,224V168a8,8,0,0,1,8-8h64a8,8,0,0,1,8,8v56Z" opacity="0.2" />
      <SvgPath
...
Icon.displayName = 'OnigiriDuotone'

export const OnigiriDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
