...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M88,48v8A32,32,0,0,1,56,88H32V80A32,32,0,0,1,64,48Z" opacity="0.2" />
      <Line
        x1="128"
        y1="24"
        x2="128"
...
Icon.displayName = 'AsclepiusDuotone'

export const AsclepiusDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
