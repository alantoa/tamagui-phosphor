...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M80,206.84V152L32,125.73l0,50.09a8,8,0,0,0,4.16,7Z" opacity="0.2" />
      <SvgPath d="M219.84,182.84a8,8,0,0,0,4.16-7v-50.1L176,152v54.84Z" opacity="0.2" />
      <SvgPath
...
export const CodesandboxLogoDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
