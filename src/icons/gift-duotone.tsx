...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M208,128v72a8,8,0,0,1-8,8H56a8,8,0,0,1-8-8V128Z" opacity="0.2" />
      <SvgRect
        x="32"
        y="80"
        width="192"
...
export const GiftDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(themed(Icon))
