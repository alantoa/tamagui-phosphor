...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <G opacity="0.2">
        <SvgPath d="M128,24c-90,0,0,96,0,96S218,24,128,24Z" />
        <SvgPath d="M32,120c0,90,96,0,96,0S32,30,32,120Z" />
        <SvgPath d="M128,216c90,0,0-96,0-96S38,216,128,216Z" />
        <SvgPath d="M128,120s96,90,96,0S128,120,128,120Z" />
      </G>
      <SvgPath
