...
const Icon = (props) => {
  ...
  return (
    <Svg viewBox="0 0 256 256" {...otherProps}>
      ...
      <SvgPath d="M128,36a92,92,0,1,0,92,92A92.1,92.1,0,0,0,128,36Z" opacity="0.2" />
      <Line
        x1="128"
        y1="64"
        x2="128"
...
Icon.displayName = 'SnowflakeDuotone'

export const SnowflakeDuotone: NamedExoticComponent<IconProps> = memo<IconProps>(
  themed(Icon)
)
